...
import './Studenteditprofile.css'; // Import CSS for styling
...
const Studenteditprofile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/student-profile'); // Redirect to profile page after successful update
        } catch (error) {
            ...
            <form className="editInput-txt" onSubmit={handleSubmit}>
                ...
                <div className="edit-buttom">
                    ...
                    <div className="cancelbutton-profile">
                        <button type="button" onClick={() => navigate('/student-profile')}>Cancel</button>
                    </div>
                </div>
            </form>
        </div>
