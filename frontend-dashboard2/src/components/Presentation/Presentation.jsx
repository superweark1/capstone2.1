...
const Presentation = () => {
  ...
  const [functionGrade, setFunctionGrade] = useState(0);
  ...
  const handleMembers = () => {
    navigate('/Presentation/Grade'); // Update with your PanelMembers route
  };
      ...
      <div className="input1">
        <div className="present">
          ...
          <div className="input-section">
            <div className="Presentationtable">
              <table>
        ...
        <div >
                <button className="Gradebuttons" onClick={handleMembers}>Grade</button>
                </div>
        <div className="timer">
